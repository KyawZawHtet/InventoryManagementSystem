...
<div class="main-wrapper">
    <div class="header">
        <div class="header-left active">
            ...
            </a> <a href="<c:url value="index.jsp"/> " class="logo-small"> <img
                src="<c:url value="/resources/assets/img/logo-small.png"/> " alt=""/>
        ...
        <ul class="nav user-menu">
                    ...
                    <form action="#">
                        <div class="searchinputs">
                            ...
                            <div class="search-addon">
									<span><img
                                            src="<c:url value="/resources/assets/img/icons/closes.svg"/>"
                                            alt="img"/></span>
                            </div>
                        </div>
                        <a class="btn" id="searchdiv"><img
                                src="<c:url value="/resources/assets/img/icons/search.svg"/> " alt="img"/></a>
                    </form>
                </div>
            </li>
            ...
            <li class="nav-item dropdown has-arrow flag-nav"><a
                    ...
                    src="<c:url value="/resources/assets/img/flags/us1.png"/> " alt="" height="20"/>
            </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="javascript:void(0);" class="dropdown-item"> <img
                            src="<c:url value="/resources/assets/img/flags/us.png"/> " alt="" height="16"/> English
                    </a> <a href="javascript:void(0);" class="dropdown-item"> <img
                        src="<c:url value="/resources/assets/img/flags/fr.png"/>" alt="" height="16"/> French
                </a> <a href="javascript:void(0);" class="dropdown-item"> <img
                        src="<c:url value="/resources/assets/img/flags/es.png"/>" alt="" height="16"/> Spanish
                </a> <a href="javascript:void(0);" class="dropdown-item"> <img
                        src="<c:url value="/resources/assets/img/flags/de.png"/>" alt="" height="16"/> German
                </a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown"><a href="javascript:void(0);"
                ...
                <img src="<c:url value="/resources/assets/img/icons/notification-bing.svg"/> " alt="img"/> <span
                ...
                <div class="dropdown-menu notifications">
                    ...
                    <div class="noti-content">
                        <ul class="notification-list">
                            <li class="notification-message"><a href="<c:url value="#"/> ">
                            ...
                            <li class="notification-message"><a href="<c:url value="#"/> ">
                                <div class="media d-flex">
											<span class="avatar flex-shrink-0"> <img alt=""
                                                                                     src="<c:url value="/resources/assets/img/profiles/avatar-03.jpg"/> "/>
											</span>
                                    <div class="media-body flex-grow-1">
                                        <p class="noti-details">
                            ...
                            <li class="notification-message"><a href="<c:url value="#"/> ">
                                <div class="media d-flex">
											<span class="avatar flex-shrink-0"> <img alt=""
                                                                                     src="<c:url value="/resources/assets/img/profiles/avatar-06.jpg"/> "/>
											</span>
                                    <div class="media-body flex-grow-1">
                                        <p class="noti-details">
                                ...
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body flex-grow-1">
                                        <p class="noti-details">
                                            ...
                                            task <span class="noti-title">Patient
            ...
            <li class="nav-item dropdown has-arrow main-drop"><a
                    ...
                    src="<c:url value="/resources/assets/img/profiles/user.png"/> " alt=""/> <span
                ...
                <div class="dropdown-menu menu-drop-user">
                    <div class="profilename">
                        ...
                        <hr class="m-0"/>
                        <a class="dropdown-item" href="<c:url value="#"/> "> <i class="me-2"
                                                                                data-feather="user"></i> My Profile
        ...
        <div class="dropdown mobile-user-menu">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item" href="<c:url value="#"/> ">My Profile</a> <a
                    class="dropdown-item" href="<c:url value="#"/>">Settings</a> <a
                    class="dropdown-item" href="<c:url value="#"/>">Logout</a>
            </div>
        </div>
    </div>
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu"><a href="javascript:void(0);"><img
                            src="<c:url value="/resources/assets/img/icons/users1.svg"/> " alt="img"/><span>
									Role</span> <span class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu"><a href="javascript:void(0);"><img
                            src="<c:url value="/resources/assets/img/icons/svg-gobbler.svg"/> " alt="img"/><span>
									Location</span> <span class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu"><a href="javascript:void(0);"><img
                            src="<c:url value="/resources/assets/img/icons/settings.svg"/> " alt="img"/><span>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="dash-widget">
                        <div class="dash-widgetimg">
								<span><img
                                        src="<c:url value="/resources/assets/img/icons/dash1.svg"/> " alt="img"/></span>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="dash-widget dash1">
                        <div class="dash-widgetimg">
								<span><img
                                        src="<c:url value="/resources/assets/img/icons/dash2.svg"/> " alt="img"/></span>
                        </div>
                        <div class="dash-widgetcontent">
                            <h5>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="dash-widget dash2">
                        <div class="dash-widgetimg">
								<span><img
                                        src="<c:url value="/resources/assets/img/icons/dash3.svg"/> " alt="img"/></span>
                        </div>
                        <div class="dash-widgetcontent">
                            <h5>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="dash-widget dash3">
                        <div class="dash-widgetimg">
								<span><img
                                        src="<c:url value="/resources/assets/img/icons/dash4.svg"/> " alt="img"/></span>
                        </div>
                        <div class="dash-widgetcontent">
                            <h5>
                            ...
                            <div class="graph-sets">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-white btn-sm dropdown-toggle"
                                        ...
                                        2022 <img src="<c:url value="/resources/assets/img/icons/dropdown.svg"/> " alt="img"
                                                  class="ms-2"/>
                                    </button>
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li><a href="javascript:void(0);" class="dropdown-item">2022</a>
                                        </li>
                                        <li><a href="javascript:void(0);" class="dropdown-item">2021</a>
                                        </li>
                                        <li><a href="javascript:void(0);" class="dropdown-item">2020</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="card flex-fill">
                        <div
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <li><a href="<c:url value="#"/> " class="dropdown-item">Product
                                        List</a></li>
                                    <li><a href="<c:url value="#"/>" class="dropdown-item">Product
                                        Add</a></li>
                                </ul>
                        ...
                        <div class="card-body">
                            <div class="table-responsive dataview">
                                <table class="table datatable">
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td class="productimgname"><a href="<c:url value="#"/>"
                                                                      class="product-img"> <img
                                                src="<c:url value="/resources/assets/img/product/product22.jpg"/> " alt="product"/>
                                        </a> <a href="<c:url value="#"/> ">Apple Earpods</a></td>
                                        <td>$891.2</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td class="productimgname"><a href="<c:url value="#"/>"
                                                                      class="product-img"> <img
                                                src="<c:url value="/resources/assets/img/product/product23.jpg"/> " alt="product"/>
                                        </a> <a href="<c:url value="#"/>">iPhone 11</a></td>
                                        <td>$668.51</td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td class="productimgname"><a href="<c:url value="#"/> "
                                                                      class="product-img"> <img
                                                src="<c:url value="/resources/assets/img/product/product24.jpg"/> " alt="product"/>
                                        </a> <a href="<c:url value="#"/> ">samsung</a></td>
                                        <td>$522.29</td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td class="productimgname"><a href="<c:url value="#"/> "
                                                                      class="product-img"> <img
                                                src="<c:url value="/resources/assets/img/product/product6.jpg"/> " alt="product"/>
                                        </a> <a href="<c:url value="#"/> ">Macbook Pro</a></td>
                                        <td>$291.01</td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <table class="table datatable">
                            ...
                            <tr>
                                ...
                                <td class="productimgname"><a class="product-img"
                                        ...
                                        src="<c:url value="/resources/assets/img/product/product2.jpg"/> " alt="product"/>
                                </a> <a href="<c:url value="#"/> ">Orange</a></td>
                                <td>N/D</td>
                                <td>Fruits</td>
                                <td>12-12-2022</td>
                            </tr>
                            <tr>
                                ...
                                <td class="productimgname"><a class="product-img"
                                                              href="<c:url value="#"/> "> <img
                                        src="<c:url value="/resources/assets/img/product/product3.jpg"/> " alt="product"/>
                                </a> <a href="<c:url value="#"/> ">Pineapple</a></td>
                                <td>N/D</td>
                                <td>Fruits</td>
                                <td>25-11-2022</td>
                            </tr>
                            <tr>
                                ...
                                <td class="productimgname"><a class="product-img"
                                                              href="<c:url value="#"/> "> <img
                                        src="<c:url value="/resources/assets/img/product/product4.jpg"/> " alt="product"/>
                                </a> <a href="<c:url value="#"/> ">Stawberry</a></td>
                                <td>N/D</td>
                                <td>Fruits</td>
                                <td>19-11-2022</td>
                            </tr>
                            <tr>
                                ...
                                <td class="productimgname"><a class="product-img"
                                                              href="<c:url value="#"/> "> <img
                                        src="<c:url value="/resources/assets/img/product/product5.jpg"/> " alt="product"/>
                                </a> <a href="<c:url value="#"/> ">Avocat</a></td>
                                <td>N/D</td>
                                <td>Fruits</td>
                                <td>20-11-2022</td>
                            </tr>
