            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul>
                            <li>
                                <a href="<c:url value="#"/> " class="active">Add Location </a>
                            </li>
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <form:form modelAttribute="location" method="post" action="../doupdate">
                            ...
                            <div class="col-lg-12">
                                ...
                                />
                                <a href="../../location/showlocations" class="btn btn-cancel">Cancel</a>
                            </div>
                        </form:form>
                    </div>
                </div>
