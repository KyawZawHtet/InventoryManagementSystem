                ...
                <ul>
                    ...
                    Order</span
                        ...
                        <ul>
                            ...
                            <li><a href="<c:url value="#"/>"  class="active">Add Order Detail </a></li>
        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    ...
                    <h6>Create new order detail</h6>
                </div>
            </div>

            <div class="card">
                <div class="card-body">
                    <form:form modelAttribute="order" method="post" action="../doupdate">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <form:select path="productId" class="select">
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    <form:label path="orderId">Order</form:label>
                                    <form:select path="orderId" class="select">
                            ...
                            <div class="col-lg-12">
                                <input href="javascript:void(0);" class="btn btn-submit me-2" type="submit" value="Update"
                                />
                                <a href="../../orderdetail/showorderdetails" class="btn btn-cancel">Cancel</a>
                            </div>
                        </div>
                    </form:form>
                </div>
